'use strict';
require('./local-cli/cli');

const through = require('through2');

const defaultConfig = require('./local-cli/default.config');
const Config = require('./local-cli/util/Config');
const Transformer = require('./packager/react-packager/src/JSTransformer');
const minify = require('./packager/react-packager/src/JSTransformer/worker/minify');

function getRNCliConfig() {
  let cwd = __dirname;

  return Config.get(cwd, defaultConfig);
}
