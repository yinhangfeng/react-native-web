...
class Server {
  ...
  constructor(options: Options) {
    this._opts = {
      ...
      serverBuildBundleInterceptorModulePath: options.serverBuildBundleInterceptorModulePath,
    };
  ...
  _callBuildBundleInterceptor(bundleOptions, entryFuncName, options, returnFull) {
    console.log('callBuildBundleInterceptor', entryFuncName, this._opts.serverBuildBundleInterceptorModulePath);
  ...
  getOrderedDependencyPaths(options: {}): Promise<mixed> {
    ...
    return this._callBuildBundleInterceptor(options, 'getOrderedDependencyPaths')
      .then((opts) => {
        return this._bundler.getOrderedDependencyPaths(dependencyOpts(opts));
      });
  }
