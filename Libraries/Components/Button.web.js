...
class Button extends React.Component<{
  ...
  render() {
    ...
    const formattedTitle = title; //Platform.OS === 'android' ? title.toUpperCase() : title;
    const Touchable = TouchableOpacity; //Platform.OS === 'android' ? TouchableNativeFeedback : TouchableOpacity;
    return (
      <Touchable
