...
const ScrollView = React.createClass({
  ...
  scrollTo: function(
    ...
    let scrollView = ReactNative.findNodeHandle(this.refs[SCROLLVIEW]);
  ...
  render: function() {
    var contentContainer =
      <View
        className={this.props.horizontal ? (CSSClassNames.SCROLL_VIEW_CONTENT + ' ' + CSSClassNames.SCROLL_VIEW_CONTENT_H) : CSSClassNames.SCROLL_VIEW_CONTENT}
        ref={INNERVIEW}
        style={this.props.contentContainerStyle}
        removeClippedSubviews={this.props.removeClippedSubviews}
        collapsable={false}
        onLayout={this.props.onContentSizeChange && this._handleContentOnLayout}>
        {this.props.children}
      </View>;

    var className = CSSClassNames.SCROLL_VIEW;
    if(this.props.horizontal) {
      className += ' ' + CSSClassNames.SCROLL_VIEW_H;
    }
    if(this.props.horizontal ? (!this.props.showsHorizontalScrollIndicator) : (!this.props.showsVerticalScrollIndicator)) {
    ...
    // TODO RW scrollEnabled scrollResponder debounce(scrollEventThrottle)
    ...
    var props = {
      ...
      onTouchCancel: this.scrollResponderHandleTouchCacnel,
