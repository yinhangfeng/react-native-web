...
var TouchableMixin = {
  ...
  touchableHandleResponderGrant: function(e) {
    //console.log('touchableHandleResponderGrant ', e, e.nativeEvent, e.pageX);
    //RW 保存初始位置  XXX 对低版本浏览器需要
    this._responderGrantLocation = {
  ...
  touchableHandleResponderRelease: function(e) {
    //console.log('touchableHandleResponderRelease ', e, e.nativeEvent, e.nativeEvent.pageX);
  ...
  _performSideEffectsForTransition: function(curState, nextState, signal, e) {
    ...
    if (IsPressingIn[curState] && signal === Signals.RESPONDER_RELEASE) {
      ...
      if (shouldInvokePress && this.touchableHandlePress) {
        //RW 检查距触摸初始点的距离 减少误触的发生几率
        // console.log('pre call touchableHandlePress', e.nativeEvent, this._responderGrantLocation);
        var _dx = Math.abs(e.nativeEvent.pageX - this._responderGrantLocation.x) || 0,
